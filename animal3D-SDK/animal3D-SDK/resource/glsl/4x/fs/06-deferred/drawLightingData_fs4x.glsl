...
layout (location = 4) out vec4 rtBiasedClipCoord;
...
void main()
{
	...
	rtViewNormal = (normalize(vViewNormal)/2.0) + 0.5;
	//rtViewNormal = vec4(1.0, 0.0, 1.0, 1.0);
	rtAtlasTexcoord = vTexcoord;
	rtBiasedClipCoord = vBiasedClipCoord;
}
